...
@section('title', 'Client Assessment Approvals')
...
<div class="container-fluid">
    ...
    <div class="stats-grid">
        <div class="stat-card pending">
            <div class="stat-number text-warning">{{ $pendingAssessments->count() }}</div>
        ...
        <div class="stat-card rejected">
            <div class="stat-number text-danger">{{ \App\Models\Client::where('assessment_status', 'rejected')->count() }}</div>
            ...
            @if($pendingAssessments->count() > 0)
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            @foreach($pendingAssessments as $client)
                            <tr>
                                <td>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <button class="btn btn-sm btn-success" onclick="approveAssessment({{ $client->id }})">
                                            <i class="fas fa-check"></i>
                                        </button>
                                        <button class="btn btn-sm btn-danger" onclick="rejectAssessment({{ $client->id }})">
