                ...
                <div class="d-flex align-items-start">
                    ...
                    <div>
                        ...
                        <div class="alert alert-warning mt-3 mb-0">
                            ...
                            <strong>Note:</strong> The main risk categories (CR, SR, PR, DR) are managed through the <a href="{{ route('risks.create') }}" class="alert-link"><strong>Risk Register</strong></a>. This page shows additional custom risk categories for extended classification.
                        </div>
                    </div>
                </div>
            </div>
