    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">
                    <i class="fas fa-edit me-2"></i>Edit Client Risk Assessment
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('client-risk.update', $clientRisk) }}" method="POST" id="assessmentForm">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('client_name') is-invalid @enderror" 
                                       id="client_name" name="client_name" value="{{ old('client_name', $clientRisk->client_name) }}" required>
                                @error('client_name')
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('client_identification_status') is-invalid @enderror" 
                                    ...
                                    @foreach($identificationStatusOptions as $status)
                                        <option value="{{ $status }}" {{ old('client_identification_status', $clientRisk->client_identification_status) == $status ? 'selected' : '' }}>
                                            {{ $status }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('client_screening_date') is-invalid @enderror" 
                                       ...
                                       value="{{ old('client_screening_date', $clientRisk->client_screening_date ? $clientRisk->client_screening_date->format('Y-m-d') : '') }}">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('client_screening_result') is-invalid @enderror" 
                                       ...
                                       value="{{ old('client_screening_result', $clientRisk->client_screening_result) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select risk-select @error('client_screening_risk_id') is-invalid @enderror" 
                                    ...
                                    @foreach($availableRiskIds as $riskId => $description)
                                        <option value="{{ $riskId }}" {{ old('client_screening_risk_id', $clientRisk->client_screening_risk_id) == $riskId ? 'selected' : '' }}>
                                            {{ $riskId }} - {{ $description }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="client_screening_description" 
                                       name="client_screening_description" value="{{ old('client_screening_description', $clientRisk->client_screening_description) }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <select class="form-select impact-select @error('client_screening_impact') is-invalid @enderror" 
                                    ...
                                    <option value="High" {{ old('client_screening_impact', $clientRisk->client_screening_impact) == 'High' ? 'selected' : '' }}>High</option>
                                    <option value="Medium" {{ old('client_screening_impact', $clientRisk->client_screening_impact) == 'Medium' ? 'selected' : '' }}>Medium</option>
                                    <option value="Low" {{ old('client_screening_impact', $clientRisk->client_screening_impact) == 'Low' ? 'selected' : '' }}>Low</option>
                                </select>
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <select class="form-select likelihood-select @error('client_screening_likelihood') is-invalid @enderror" 
                                        ...
                                        data-section="client_screening">
                                    <option value="">Select</option>
                                    <option value="High" {{ old('client_screening_likelihood', $clientRisk->client_screening_likelihood) == 'High' ? 'selected' : '' }}>High</option>
                                    <option value="Medium" {{ old('client_screening_likelihood', $clientRisk->client_screening_likelihood) == 'Medium' ? 'selected' : '' }}>Medium</option>
                                    <option value="Low" {{ old('client_screening_likelihood', $clientRisk->client_screening_likelihood) == 'Low' ? 'selected' : '' }}>Low</option>
                                </select>
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control risk-rating-display" 
                                       ...
                                       value="{{ old('client_screening_risk_rating', $clientRisk->client_screening_risk_rating) }}" readonly>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select risk-select @error('client_category_risk_id') is-invalid @enderror" 
                                    ...
                                    <option value="">Please select Risk ID</option>
                                    @foreach($availableRiskIds as $riskId => $description)
                                        <option value="{{ $riskId }}" {{ old('client_category_risk_id', $clientRisk->client_category_risk_id) == $riskId ? 'selected' : '' }}>
                                            {{ $riskId }} - {{ $description }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="client_category_description" 
                                       name="client_category_description" value="{{ old('client_category_description', $clientRisk->client_category_description) }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <select class="form-select impact-select @error('client_category_impact') is-invalid @enderror" 
                                        ...
                                        data-section="client_category">
                                    <option value="">Select</option>
                                    <option value="High" {{ old('client_category_impact', $clientRisk->client_category_impact) == 'High' ? 'selected' : '' }}>High</option>
                                    <option value="Medium" {{ old('client_category_impact', $clientRisk->client_category_impact) == 'Medium' ? 'selected' : '' }}>Medium</option>
                                    <option value="Low" {{ old('client_category_impact', $clientRisk->client_category_impact) == 'Low' ? 'selected' : '' }}>Low</option>
                                </select>
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <select class="form-select likelihood-select @error('client_category_likelihood') is-invalid @enderror" 
                                        ...
                                        data-section="client_category">
                                    <option value="">Select</option>
                                    <option value="High" {{ old('client_category_likelihood', $clientRisk->client_category_likelihood) == 'High' ? 'selected' : '' }}>High</option>
                                    <option value="Medium" {{ old('client_category_likelihood', $clientRisk->client_category_likelihood) == 'Medium' ? 'selected' : '' }}>Medium</option>
                                    <option value="Low" {{ old('client_category_likelihood', $clientRisk->client_category_likelihood) == 'Low' ? 'selected' : '' }}>Low</option>
                                </select>
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control risk-rating-display" 
                                       ...
                                       value="{{ old('client_category_risk_rating', $clientRisk->client_category_risk_rating) }}" readonly>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select risk-select @error('requested_services_risk_id') is-invalid @enderror" 
                                    ...
                                    <option value="">Please select Risk ID</option>
                                    @foreach($availableRiskIds as $riskId => $description)
                                        <option value="{{ $riskId }}" {{ old('requested_services_risk_id', $clientRisk->requested_services_risk_id) == $riskId ? 'selected' : '' }}>
                                            {{ $riskId }} - {{ $description }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="requested_services_description" 
                                       name="requested_services_description" value="{{ old('requested_services_description', $clientRisk->requested_services_description) }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <select class="form-select impact-select @error('requested_services_impact') is-invalid @enderror" 
                                        ...
                                        data-section="requested_services">
                                    <option value="">Select</option>
                                    <option value="High" {{ old('requested_services_impact', $clientRisk->requested_services_impact) == 'High' ? 'selected' : '' }}>High</option>
                                    <option value="Medium" {{ old('requested_services_impact', $clientRisk->requested_services_impact) == 'Medium' ? 'selected' : '' }}>Medium</option>
                                    <option value="Low" {{ old('requested_services_impact', $clientRisk->requested_services_impact) == 'Low' ? 'selected' : '' }}>Low</option>
                                </select>
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <select class="form-select likelihood-select @error('requested_services_likelihood') is-invalid @enderror" 
                                        ...
                                        data-section="requested_services">
                                    <option value="">Select</option>
                                    <option value="High" {{ old('requested_services_likelihood', $clientRisk->requested_services_likelihood) == 'High' ? 'selected' : '' }}>High</option>
                                    <option value="Medium" {{ old('requested_services_likelihood', $clientRisk->requested_services_likelihood) == 'Medium' ? 'selected' : '' }}>Medium</option>
                                    <option value="Low" {{ old('requested_services_likelihood', $clientRisk->requested_services_likelihood) == 'Low' ? 'selected' : '' }}>Low</option>
                                </select>
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control risk-rating-display" 
                                       ...
                                       value="{{ old('requested_services_risk_rating', $clientRisk->requested_services_risk_rating) }}" readonly>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select risk-select @error('payment_option_risk_id') is-invalid @enderror" 
                                    ...
                                    <option value="">Please select Risk ID</option>
                                    @foreach($availableRiskIds as $riskId => $description)
                                        <option value="{{ $riskId }}" {{ old('payment_option_risk_id', $clientRisk->payment_option_risk_id) == $riskId ? 'selected' : '' }}>
                                            {{ $riskId }} - {{ $description }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="payment_option_description" 
                                       name="payment_option_description" value="{{ old('payment_option_description', $clientRisk->payment_option_description) }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <select class="form-select impact-select @error('payment_option_impact') is-invalid @enderror" 
                                        ...
                                        data-section="payment_option">
                                    <option value="">Select</option>
                                    <option value="High" {{ old('payment_option_impact', $clientRisk->payment_option_impact) == 'High' ? 'selected' : '' }}>High</option>
                                    <option value="Medium" {{ old('payment_option_impact', $clientRisk->payment_option_impact) == 'Medium' ? 'selected' : '' }}>Medium</option>
                                    <option value="Low" {{ old('payment_option_impact', $clientRisk->payment_option_impact) == 'Low' ? 'selected' : '' }}>Low</option>
                                </select>
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <select class="form-select likelihood-select @error('payment_option_likelihood') is-invalid @enderror" 
                                        ...
                                        data-section="payment_option">
                                    <option value="">Select</option>
                                    <option value="High" {{ old('payment_option_likelihood', $clientRisk->payment_option_likelihood) == 'High' ? 'selected' : '' }}>High</option>
                                    <option value="Medium" {{ old('payment_option_likelihood', $clientRisk->payment_option_likelihood) == 'Medium' ? 'selected' : '' }}>Medium</option>
                                    <option value="Low" {{ old('payment_option_likelihood', $clientRisk->payment_option_likelihood) == 'Low' ? 'selected' : '' }}>Low</option>
                                </select>
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control risk-rating-display" 
                                       ...
                                       value="{{ old('payment_option_risk_rating', $clientRisk->payment_option_risk_rating) }}" readonly>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select risk-select @error('delivery_method_risk_id') is-invalid @enderror" 
                                    ...
                                    <option value="">Please select Risk ID</option>
                                    @foreach($availableRiskIds as $riskId => $description)
                                        <option value="{{ $riskId }}" {{ old('delivery_method_risk_id', $clientRisk->delivery_method_risk_id) == $riskId ? 'selected' : '' }}>
                                            {{ $riskId }} - {{ $description }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="delivery_method_description" 
                                       name="delivery_method_description" value="{{ old('delivery_method_description', $clientRisk->delivery_method_description) }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <select class="form-select impact-select @error('delivery_method_impact') is-invalid @enderror" 
                                        ...
                                        data-section="delivery_method">
                                    <option value="">Select</option>
                                    <option value="High" {{ old('delivery_method_impact', $clientRisk->delivery_method_impact) == 'High' ? 'selected' : '' }}>High</option>
                                    <option value="Medium" {{ old('delivery_method_impact', $clientRisk->delivery_method_impact) == 'Medium' ? 'selected' : '' }}>Medium</option>
                                    <option value="Low" {{ old('delivery_method_impact', $clientRisk->delivery_method_impact) == 'Low' ? 'selected' : '' }}>Low</option>
                                </select>
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <select class="form-select likelihood-select @error('delivery_method_likelihood') is-invalid @enderror" 
                                        ...
                                        data-section="delivery_method">
                                    <option value="">Select</option>
                                    <option value="High" {{ old('delivery_method_likelihood', $clientRisk->delivery_method_likelihood) == 'High' ? 'selected' : '' }}>High</option>
                                    <option value="Medium" {{ old('delivery_method_likelihood', $clientRisk->delivery_method_likelihood) == 'Medium' ? 'selected' : '' }}>Medium</option>
                                    <option value="Low" {{ old('delivery_method_likelihood', $clientRisk->delivery_method_likelihood) == 'Low' ? 'selected' : '' }}>Low</option>
                                </select>
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control risk-rating-display" 
                                       ...
                                       value="{{ old('delivery_method_risk_rating', $clientRisk->delivery_method_risk_rating) }}" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-3">
                            <div class="card bg-primary text-white">
                                <div class="card-body text-center">
                                    <h4 id="overallRiskPoints">{{ $clientRisk->total_points ?? 0 }}</h4>
                        ...
                        <div class="col-md-3">
                            <div class="card" id="overallRiskRatingCard">
                                <div class="card-body text-center">
                                    <h4 id="overallRiskRating">{{ $clientRisk->overall_risk_rating ?? '-' }}</h4>
                        ...
                        <div class="col-md-3">
                            <div class="card" id="clientAcceptanceCard">
                                <div class="card-body text-center">
                                    <h4 id="clientAcceptance">{{ $clientRisk->client_acceptance ?? '-' }}</h4>
                        ...
                        <div class="col-md-3">
                            <div class="card bg-info text-white">
                                <div class="card-body text-center">
                                    <h4 id="ongoingMonitoring">{{ $clientRisk->monitoring_frequency ?? '-' }}</h4>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('dcs_risk_appetite') is-invalid @enderror" 
                                       ...
                                       value="{{ old('dcs_risk_appetite', $clientRisk->dcs_risk_appetite) }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('dcs_comments') is-invalid @enderror" 
                                          id="dcs_comments" name="dcs_comments" rows="3">{{ old('dcs_comments', $clientRisk->dcs_comments) }}</textarea>
                                @error('dcs_comments')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Auto-fill fields for existing data on page load
    console.log('Setting up initial auto-fill for existing data');
    const riskSections = ['client_screening', 'client_category', 'requested_services', 'payment_option', 'delivery_method'];
    riskSections.forEach(section => {
        const riskId = document.getElementById(section + '_risk_id').value;
        console.log('Section:', section, 'Initial Risk ID:', riskId);
        if (riskId) {
            console.log('Calling autoFillRiskFields for existing data');
            autoFillRiskFields(section, riskId);
        }
    });
});
