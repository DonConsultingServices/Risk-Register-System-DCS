...
<head>
    ...
    <!-- Matrix Styles -->
    <link href="{{ asset('css/matrix.css') }}?v={{ time() }}" rel="stylesheet">
...
<body>
    ...
    <nav class="sidebar" style="position: fixed !important; left: 0 !important; top: 0 !important; width: 260px !important; height: 100vh !important; overflow: hidden !important; z-index: 1000 !important; background: linear-gradient(180deg, #000745 0%, #001e5f 100%) !important;">
        <div class="sidebar-header">
            <img src="{{ asset('logo/logo.png') }}" alt="DCS Logo" onerror="this.style.display='none'">
        ...
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('dashboard') ? 'active' : '' }}" href="{{ route('dashboard') }}" style="color: #ffffff !important; display: block !important;">
                    <i class="fas fa-tachometer-alt"></i>
                    Dashboard
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('clients.*') ? 'active' : '' }}" href="{{ route('clients.index') }}" style="color: #ffffff !important; display: block !important;">
                    <i class="fas fa-users"></i>
                    Client Management
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('risks.index') || request()->routeIs('risks.create') ? 'active' : '' }}" href="{{ route('risks.index') }}" style="color: #ffffff !important; display: block !important;">
                    <i class="fas fa-exclamation-triangle"></i>
                    Risk Register
                </a>
            </li>
            @if(auth()->user()->canManageRiskCategories())
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('risk-categories.*') ? 'active' : '' }}" href="{{ route('risk-categories.index') }}" style="color: #ffffff !important; display: block !important;">
            ...
            @endif
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('risks.reports') ? 'active' : '' }}" href="{{ route('risks.reports') }}" style="color: #ffffff !important; display: block !important;">
                    <i class="fas fa-chart-bar"></i>
                    Reports
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('messages.*') ? 'active' : '' }}" href="{{ route('messages.index') }}" style="color: #ffffff !important; display: block !important;">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('users.*') ? 'active' : '' }}" href="{{ route('users.index') }}" style="color: #ffffff !important; display: block !important;">
                    <i class="fas fa-users"></i>
                    Users
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('risks.settings') ? 'active' : '' }}" href="{{ route('risks.settings') }}" style="color: #ffffff !important; display: block !important;">
        ...
        <div class="mt-auto" style="padding: 0.75rem; border-top: 1px solid rgba(255,255,255,0.1);">
            <div class="text-center">
                ...
                <span class="text-white" style="font-size: 0.8rem; font-weight: 500;">{{ auth()->user()->name ?? 'User' }}</span><br>
                <small class="text-white-50" style="font-size: 0.7rem;">{{ ucfirst(auth()->user()->role ?? 'admin') }}</small>
            </div>
        </div>
    </nav>
        ...
        <div class="top-bar">
            ...
            <div class="d-lg-none mobile-header-content">
                <div class="mobile-header-left">
                    ...
                    <img src="{{ asset('logo/logo.png') }}" alt="DCS Logo" class="mobile-logo" onerror="this.style.display='none'">
                    <h1 class="mobile-title">@yield('page-title', 'DCS')</h1>
                </div>
                <div class="mobile-actions">
                    ...
                    <!-- Mobile Messages -->
                    <button class="mobile-message-btn" title="Messages" onclick="window.location.href='{{ route('messages.index') }}'">
                        <i class="fas fa-envelope"></i>
                        ...
                        <div class="dropdown-menu user-profile-dropdown" aria-labelledby="mobileUserDropdown">
                            <div class="user-profile-header">
                                ...
                                <div class="user-profile-info">
                                    ...
                                    <div class="user-profile-email">{{ auth()->user()->email ?? 'user@example.com' }}</div>
                                    <div class="user-profile-role">{{ ucfirst(auth()->user()->role ?? 'admin') }}</div>
                                </div>
                            </div>
                            <div class="user-profile-menu">
                                <a href="{{ route('users.show', auth()->id()) }}" class="user-profile-item">
                                    <i class="fas fa-user"></i>
                                    <span>My Profile</span>
                                </a>
                                <a href="{{ route('risks.settings') }}" class="user-profile-item">
                                    <i class="fas fa-cog"></i>
                                    <span>Settings</span>
                                </a>
                    ...
                    <form method="POST" action="{{ route('logout') }}" style="display: inline;" id="mobileLogoutForm" onsubmit="showLogoutSpinner(event)">
                        @csrf
                ...
                <div class="compact-profile">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu profile-dropdown" aria-labelledby="profileDropdown">
                            ...
                            <a href="{{ route('risks.settings') }}" class="dropdown-item">
                                <i class="fas fa-cog"></i>
                                <span>Settings</span>
                            </a>
                            ...
                            <!-- Logout -->
                            <form method="POST" action="{{ route('logout') }}" style="display: inline;" id="desktopLogoutForm" onsubmit="showLogoutSpinner(event)">
                                @csrf
    ...
    <script>
        ...
        function showAboutModal() {
            fetch('{{ route("profile.system-info") }}', {
                method: 'GET',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                    'Content-Type': 'application/json'
