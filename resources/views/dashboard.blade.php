...
@section('title', 'Dashboard - DCS-Best')
...
<div class="dashboard-container">
    ...
    <div class="welcome-section">
        <h2 class="welcome-title">Welcome back, {{ auth()->user()->name ?? 'User' }}!</h2>
    ...
    <div class="stats-grid">
        <a href="{{ route('risks.reports') }}" class="stat-card primary clickable-stat">
            <div class="stat-content">
                <div class="stat-info">
                    <h3 id="total-risks">{{ $totalRisks ?? 0 }}</h3>
                    <p>Risk Records</p>
                </div>
        ...
        <a href="{{ route('clients.index') }}" class="stat-card success clickable-stat">
            <div class="stat-content">
                <div class="stat-info">
                    <h3 id="active-clients">{{ $activeClients ?? 0 }}</h3>
        ...
        <a href="{{ route('risks.reports', ['filter' => 'high_risk']) }}" class="stat-card warning clickable-stat">
            <div class="stat-content">
                <div class="stat-info">
                    <h3 id="high-risk-clients">{{ $highRiskClients ?? 0 }}</h3>
        ...
        @if(auth()->user()->canApproveRisks())
        <a href="{{ route('client-assessments.approval.index') }}" class="stat-card warning clickable-stat">
            <div class="stat-content">
                <div class="stat-info">
                    <h3 id="pending-client-assessments">{{ $pendingClientAssessments ?? 0 }}</h3>
        ...
        <a href="{{ route('risks.reports', ['filter' => 'rejected']) }}" class="stat-card danger clickable-stat">
            <div class="stat-content">
                <div class="stat-info">
                    <h3 id="rejected-clients">{{ $rejectedClients ?? 0 }}</h3>
    ...
    <div class="quick-actions">
        ...
        <div class="actions-grid">
            <a href="{{ route('risk-categories.index') }}" class="action-btn primary">
                <i class="fas fa-folder"></i>
                <span>Add Risk</span>
            </a>
            <a href="{{ route('risks.reports') }}" class="action-btn info">
                <i class="fas fa-chart-bar"></i>
                <span>View Reports</span>
            </a>
            @if(auth()->user()->canApproveRisks())
            <a href="{{ route('risks.approval.index') }}" class="action-btn warning">
