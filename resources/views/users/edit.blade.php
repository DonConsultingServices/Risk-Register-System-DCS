        ...
        <div class="col-12">
            <div class="page-header">
                <div class="page-header-content">
                    <h1 class="page-title">{{ auth()->user()->isStaff() && auth()->id() == $user->id ? 'Edit Profile' : 'Edit User' }}</h1>
                    <p class="page-description">{{ auth()->user()->isStaff() && auth()->id() == $user->id ? 'Update your profile information' : 'Update user information and permissions' }}</p>
                </div>
                            ...
                            <form method="POST" action="{{ route('users.update', $user) }}">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="alert alert-info">
                                            ...
                                            <strong>Current Role:</strong> {{ ucfirst($user->role) }}
                                            <br>
                                ...
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        ...
                                        {{ auth()->user()->isStaff() && auth()->id() == $user->id ? 'Update Profile' : 'Update User' }}
                                    </button>
                                </div>
                            </form>
                        </div>
