...
@section('title', 'User Management - DCS-Best')
        ...
        <div class="col-12">
            ...
            <div class="row mb-4">
                <div class="col-md-2">
                    <div class="card stat-card">
                        <div class="card-body text-center">
                            <h3 class="stat-number">{{ $counts['all'] }}</h3>
                ...
                <div class="col-md-2">
                    <div class="card stat-card">
                        <div class="card-body text-center">
                            <h3 class="stat-number text-success">{{ $counts['active'] }}</h3>
                ...
                <div class="col-md-2">
                    <div class="card stat-card">
                        <div class="card-body text-center">
                            <h3 class="stat-number text-danger">{{ $counts['inactive'] }}</h3>
                ...
                <div class="col-md-2">
                    <div class="card stat-card">
                        <div class="card-body text-center">
                            <h3 class="stat-number text-primary">{{ $counts['admin'] }}</h3>
                ...
                <div class="col-md-2">
                    <div class="card stat-card">
                        <div class="card-body text-center">
                            <h3 class="stat-number text-warning">{{ $counts['manager'] }}</h3>
                ...
                <div class="col-md-2">
                    <div class="card stat-card">
                        <div class="card-body text-center">
                            <h3 class="stat-number text-info">{{ $counts['staff'] }}</h3>
...
function deleteUser(userId, userName) {
    ...
    newConfirmBtn.onclick = function() {
        ...
        // console.log('Delete URL:', `{{ url('/users') }}/${userId}`);
