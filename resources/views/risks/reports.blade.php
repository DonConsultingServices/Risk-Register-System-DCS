                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" id="quickFilter">
                            ...
                            <option value="open" {{ request('filter') == 'open' ? 'selected' : '' }}>Open Assessments</option>
                            <option value="closed" {{ request('filter') == 'closed' ? 'selected' : '' }}>Closed Assessments</option>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endphp
                                    <span class="badge bg-{{ $riskColor }} fs-6">
                                        {{ $riskLevel }}
                                    </span>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <span class="badge bg-{{ $statusColor }} fs-6">
                                        {{ ucfirst($risk->assessment_status ?? 'Pending') }}
                                    </span>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('clients.show', $risk->client_id) }}" class="btn btn-sm btn-outline-primary" title="View Client Details">
                                        ...
                                        @endif
                                        @if($risk->assessment_status === 'pending')
