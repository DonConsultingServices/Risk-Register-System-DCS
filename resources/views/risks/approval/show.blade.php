...
@section('title', 'Review Risk Approval')
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="page-subtitle">Risk ID: <span class="risk-id">#{{ $risk->id }}</span></p>
            </div>
            <div>
                <a href="{{ route('risks.approval.index') }}" class="btn btn-outline-light">
            ...
            <div class="risk-details-card">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="detail-row">
                        ...
                        <div class="detail-value">{{ $risk->title }}</div>
                    </div>
                            ...
                            @if($risk->client)
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        @if($risk->client->email)
                                            <br><small class="text-muted">{{ $risk->client->email }}</small>
                                        @endif
                                    </div>
                                    <div class="ms-3">
                                        <button class="btn btn-sm btn-outline-info" onclick="viewClientHistory('{{ $risk->client->name }}', {{ $risk->client->id }})" title="View Complete Assessment History">
                    ...
                    <div class="detail-row">
                        ...
                        <div class="detail-value">
                            <span class="badge bg-secondary">{{ $risk->risk_category }}</span>
                        </div>
                    </div>
                    ...
                    <div class="detail-row">
                        ...
                        <div class="detail-value">{{ $risk->impact }}</div>
                    </div>
                    
                    <div class="detail-row">
                        <div class="detail-label">Likelihood</div>
                        <div class="detail-value">{{ $risk->likelihood }}</div>
                    </div>
                    ...
                    <div class="detail-row">
                        ...
                        <div class="detail-value">{{ $risk->mitigation_strategies }}</div>
                    </div>
                    ...
                    <div class="detail-row">
                        ...
                        <div class="detail-value">{{ $risk->assignedUser->name }}</div>
                    </div>
                    @endif
                    ...
                    <div class="detail-row">
                        ...
                        <div class="detail-value">{{ $risk->overall_risk_points ?? 'N/A' }}</div>
                    </div>
                    
                    <div class="detail-row">
                        <div class="detail-label">Overall Risk Rating</div>
                        <div class="detail-value">{{ $risk->overall_risk_rating ?? 'N/A' }}</div>
                    </div>
                    
                    <div class="detail-row">
                        <div class="detail-label">Client Acceptance</div>
                        <div class="detail-value">{{ $risk->client_acceptance ?? 'N/A' }}</div>
                    </div>
                    
                    <div class="detail-row">
                        <div class="detail-label">Ongoing Monitoring</div>
                        <div class="detail-value">{{ $risk->ongoing_monitoring ?? 'N/A' }}</div>
                    </div>
                    
                    <div class="detail-row">
                        <div class="detail-label">DCS Risk Appetite</div>
                        <div class="detail-value">{{ $risk->dcs_risk_appetite ?? 'N/A' }}</div>
                    </div>
                    
                    @if($risk->dcs_comments)
                    <div class="detail-row">
                        <div class="detail-label">DCS Comments</div>
                        <div class="detail-value">{{ $risk->dcs_comments }}</div>
                    </div>
                    @endif
                </div>
            </div>
            ...
            <div class="action-buttons">
                ...
                <div class="text-start">
                    ...
                    <p class="small text-muted mb-1">
                        <strong>Created by:</strong> {{ $risk->creator->name ?? 'Unknown' }}<br>
                        <strong>Created:</strong> {{ $risk->created_at->format('M d, Y H:i') }}<br>
                        <strong>Last updated:</strong> {{ $risk->updated_at->format('M d, Y H:i') }}
                    </p>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="approvalModal" tabindex="-1" aria-labelledby="approvalModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('risks.approval.approve', $risk) }}" method="POST">
                @csrf
...
<div class="modal fade" id="rejectionModal" tabindex="-1" aria-labelledby="rejectionModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('risks.approval.reject', $risk) }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
