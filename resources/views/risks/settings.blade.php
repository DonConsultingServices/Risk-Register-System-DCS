...
@section('title', 'Risk Management Settings')
            ...
            <div class="card border-danger shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex gap-3 flex-wrap">
                        <form action="{{ route('system.backup.database') }}" method="POST" class="d-inline">
                            @csrf
                        ...
                        <form action="{{ route('system.backup.full') }}" method="POST" class="d-inline">
                            @csrf
    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-6">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('risks.settings.update') }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="risk_assessment_frequency" name="risk_assessment_frequency">
                                @php $frequency = old('risk_assessment_frequency', $settings['risk_assessment_frequency'] ?? 'monthly'); @endphp
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="auto_risk_scoring" name="auto_risk_scoring" value="1" 
                                       {{ old('auto_risk_scoring', $settings['auto_risk_scoring'] ?? false) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="risk_threshold_high" name="risk_threshold_high" 
                                   value="{{ old('risk_threshold_high', $settings['risk_threshold_high'] ?? 15) }}" min="1" max="25">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="risk_threshold_critical" name="risk_threshold_critical" 
                                   value="{{ old('risk_threshold_critical', $settings['risk_threshold_critical'] ?? 20) }}" min="1" max="25">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="auto_rejection_enabled" name="auto_rejection_enabled" value="1" 
                                       {{ old('auto_rejection_enabled', $riskThresholdSettings['auto_rejection_enabled'] ?? true) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="auto_rejection_threshold" name="auto_rejection_threshold" 
                                   value="{{ old('auto_rejection_threshold', $riskThresholdSettings['auto_rejection_threshold'] ?? 20) }}" min="1" max="30">
        ...
        <div class="col-lg-6">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('risks.settings.notifications') }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="high_risk_alerts" name="high_risk_alerts" value="1" 
                                       {{ old('high_risk_alerts', $settings['high_risk_alerts'] ?? true) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="overdue_notifications" name="overdue_notifications" value="1" 
                                       {{ old('overdue_notifications', $settings['overdue_notifications'] ?? true) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="notification_frequency" name="notification_frequency">
                                @php $frequency = old('notification_frequency', $settings['notification_frequency'] ?? 'immediate'); @endphp
                                ...
                                <option value="weekly" {{ $frequency == 'weekly' ? 'selected' : '' }}>Weekly Summary</option>
                            </select>
                        </div>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="color-preview me-2" 
                                                         style="width: 20px; height: 20px; background-color: {{ $category->getFormattedColor() }}; border-radius: 4px;"></div>
                                                    <span>{{ $category->getFormattedColor() }}</span>
                                                </div>
                                            </td>
                                            <td>{{ $category->risks_count ?? 0 }}</td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    <button type="button" class="btn btn-outline-primary" 
                                                            onclick="editCategory({{ $category->id }}, '{{ addslashes($category->name) }}', '{{ addslashes($category->description ?? '') }}', '{{ $category->getFormattedColor() }}')">
            ...
            <div class="card shadow-sm border-info">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <p class="mb-0">{{ $systemInfo['version'] ?? '1.0.0' }}</p>
                    </div>
                    
                    <div class="mb-3">
                        <label class="form-label fw-bold">Last Updated</label>
                        <p class="mb-0">{{ $systemInfo['last_updated'] ?? 'Never' }}</p>
                    </div>
                    
                    <div class="mb-3">
                        <label class="form-label fw-bold">Database Records</label>
                        <p class="mb-0">{{ $systemInfo['total_risks'] ?? 0 }} risks, {{ $systemInfo['total_clients'] ?? 0 }} clients</p>
                    </div>
                    
                    <div class="mb-3">
                        <label class="form-label fw-bold">Cache Status</label>
                        <p class="mb-0">
                            @if($systemInfo['cache_enabled'] ?? false)
