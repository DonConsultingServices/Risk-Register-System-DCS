        ...
        <div class="col-12">
            <div class="page-header">
                <div class="page-header-content">
                    <h1 class="page-title"><?php echo e(auth()->user()->isStaff() && auth()->id() == $user->id ? 'Edit Profile' : 'Edit User'); ?></h1>
                    <p class="page-description"><?php echo e(auth()->user()->isStaff() && auth()->id() == $user->id ? 'Update your profile information' : 'Update user information and permissions'); ?></p>
                </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="alert alert-info">
                                            ...
                                            <strong>Current Role:</strong> <?php echo e(ucfirst($user->role)); ?>

                                            <br>
                                            <small>Contact an administrator to change your role or account status.</small>
                                        </div>
                                    </div>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        ...
                                        <?php echo e(auth()->user()->isStaff() && auth()->id() == $user->id ? 'Update Profile' : 'Update User'); ?>
                    ...
                    <!-- Password Reset Section - Only for Admin/Manager -->
                    <?php if(auth()->user()->isManagerOrAdmin() && auth()->id() != $user->id): ?>
                    <div class="card mt-4">
                        <div class="card-header">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('resetPasswordForm').addEventListener('submit', function(e) {
        ...
        fetch(`/users/<?php echo e($user->id); ?>/reset-password`, {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DCS-Best\resources\views/users/edit.blade.php ENDPATH**/ ?>