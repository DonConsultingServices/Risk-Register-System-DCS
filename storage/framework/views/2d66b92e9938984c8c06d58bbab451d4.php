...
<style>
    ...
    /* Make outline buttons more visible */
    .btn-outline-primary {
        border-color: #007bff;
        color: #007bff;
    }
...
<div class="container-fluid">
    ...
    <div class="stats-grid mb-4">
        ...
        <div class="stats-card stats-card-success">
            <div class="stat-content">
                <div class="stat-info">
                    <h3><?php echo e($lowRiskClients); ?></h3>
                    <p>Low Risk</p>
                </div>
                <div class="stat-icon">
        ...
        <div class="stats-card stats-card-warning">
            <div class="stat-content">
                <div class="stat-info">
                    <h3><?php echo e($mediumRiskClients); ?></h3>
                    <p>Medium Risk</p>
                </div>
                <div class="stat-icon">
        ...
        <div class="stats-card stats-card-danger">
            <div class="stat-content">
                <div class="stat-info">
                    <h3><?php echo e($highRiskClients); ?></h3>
                    <p>High Risk</p>
                </div>
                <div class="stat-icon">
        ...
        <?php if(($pendingClients ?? 0) > 0): ?>
        <div class="stats-card stats-card-secondary">
            <div class="stat-content">
                <div class="stat-info">
                    <h3><?php echo e($pendingClients); ?></h3>
                    <p>Pending</p>
                </div>
                <div class="stat-icon">
        ...
        <div class="stats-card stats-card-danger">
            <div class="stat-content">
                <div class="stat-info">
                    <h3><?php echo e($rejectedClients); ?></h3>
                    <p>Rejected</p>
                </div>
                <div class="stat-icon">
             ...
             <div class="table-container">
                 <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr data-client-name="<?php echo e($client->name); ?>" class="client-main-row">
                            <!-- Checkbox and Basic Info -->
                            <td class="text-center">
                                <input type="checkbox" class="form-check-input client-checkbox" value="<?php echo e($client->id); ?>" data-client-name="<?php echo e($client->name); ?>">
                                <small class="text-muted d-block">ID: <?php echo e($client->id); ?></small>
                            </td>
                                    ...
                                    <div>
                                        ...
                                        <?php
                                            ...
                                            $assessmentCount = \App\Models\Client::where('name', $clientName)
                                                ...
                                                ->count();
                                        ?>
                                        <?php if($assessmentCount > 1): ?>
                                            <small class="badge bg-info ms-1" title="This client has <?php echo e($assessmentCount); ?> assessments">
                                                <i class="fas fa-history me-1"></i><?php echo e($assessmentCount); ?>
                            ...
                            <!-- Client Screening -->
                            <td class="text-center">
                                <?php if($client->client_screening_date): ?>
                                    <?php echo e(\Carbon\Carbon::parse($client->client_screening_date)->format('d-M-Y')); ?>
                            ...
                            <td class="text-center">
                                <?php if($client->client_screening_result): ?>
                                    <span class="badge bg-info"><?php echo e($client->client_screening_result); ?></span>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="text-center">
                                <?php if(isset($client->cr_risk_id) && $client->cr_risk_id): ?>
                                    <span class="badge bg-primary"><?php echo e($client->cr_risk_id); ?></span>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <?php if(isset($client->cr_risk_name) && $client->cr_risk_name): ?>
                                    <small class="text-muted"><?php echo e(Str::limit($client->cr_risk_name, 20)); ?></small>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <?php if(isset($client->cr_impact) && $client->cr_impact): ?>
                                    <?php
                                        $crImpactColor = $client->cr_impact === 'High' ? 'danger' : 
                                                       ($client->cr_impact === 'Medium' ? 'warning' : 'success');
                                    ?>
                                    <span class="badge bg-<?php echo e($crImpactColor); ?>"><?php echo e($client->cr_impact); ?></span>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <?php if(isset($client->cr_risk_rating) && $client->cr_risk_rating): ?>
                                    <?php
                                        $crRatingColor = str_contains($client->cr_risk_rating, 'High') ? 'danger' : 
                                                       (str_contains($client->cr_risk_rating, 'Medium') ? 'warning' : 'success');
                                    ?>
                                    <span class="badge bg-<?php echo e($crRatingColor); ?>"><?php echo e($client->cr_risk_rating); ?></span>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="text-center">
                                <?php if(isset($client->sr_risk_id) && $client->sr_risk_id): ?>
                                    <span class="badge bg-primary"><?php echo e($client->sr_risk_id); ?></span>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <?php if(isset($client->sr_risk_name) && $client->sr_risk_name): ?>
                        <small class="text-muted"><?php echo e(Str::limit($client->sr_risk_name, 20)); ?></small>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <?php if(isset($client->sr_impact) && $client->sr_impact): ?>
                                    <?php
                                        $srImpactColor = $client->sr_impact === 'High' ? 'danger' : 
                                                       ($client->sr_impact === 'Medium' ? 'warning' : 'success');
                                    ?>
                                    <span class="badge bg-<?php echo e($srImpactColor); ?>"><?php echo e($client->sr_impact); ?></span>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <?php if(isset($client->sr_risk_rating) && $client->sr_risk_rating): ?>
                                    <?php
                                        $srRatingColor = str_contains($client->sr_risk_rating, 'High') ? 'danger' : 
                                                       (str_contains($client->sr_risk_rating, 'Medium') ? 'warning' : 'success');
                                    ?>
                                    <span class="badge bg-<?php echo e($srRatingColor); ?>"><?php echo e($client->sr_risk_rating); ?></span>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="text-center">
                                <?php if(isset($client->pr_risk_id) && $client->pr_risk_id): ?>
                                    <span class="badge bg-primary"><?php echo e($client->pr_risk_id); ?></span>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <?php if(isset($client->pr_risk_name) && $client->pr_risk_name): ?>
                        <small class="text-muted"><?php echo e(Str::limit($client->pr_risk_name, 20)); ?></small>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <?php if(isset($client->pr_impact) && $client->pr_impact): ?>
                                    <?php
                                        $prImpactColor = $client->pr_impact === 'High' ? 'danger' : 
                                                       ($client->pr_impact === 'Medium' ? 'warning' : 'success');
                                    ?>
                                    <span class="badge bg-<?php echo e($prImpactColor); ?>"><?php echo e($client->pr_impact); ?></span>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <?php if(isset($client->pr_risk_rating) && $client->pr_risk_rating): ?>
                                    <?php
                                        $prRatingColor = str_contains($client->pr_risk_rating, 'High') ? 'danger' : 
                                                       (str_contains($client->pr_risk_rating, 'Medium') ? 'warning' : 'success');
                                    ?>
                                    <span class="badge bg-<?php echo e($prRatingColor); ?>"><?php echo e($client->pr_risk_rating); ?></span>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="text-center">
                                <?php if(isset($client->dr_risk_id) && $client->dr_risk_id): ?>
                                    <span class="badge bg-primary"><?php echo e($client->dr_risk_id); ?></span>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <?php if(isset($client->dr_risk_name) && $client->dr_risk_name): ?>
                                    <small class="text-muted"><?php echo e(Str::limit($client->dr_risk_name, 20)); ?></small>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <?php if(isset($client->dr_impact) && $client->dr_impact): ?>
                                    <?php
                                        $drImpactColor = $client->dr_impact === 'High' ? 'danger' : 
                                                       ($client->dr_impact === 'Medium' ? 'warning' : 'success');
                                    ?>
                                    <span class="badge bg-<?php echo e($drImpactColor); ?>"><?php echo e($client->dr_impact); ?></span>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <?php if(isset($client->dr_likelihood) && $client->dr_likelihood): ?>
                                    <?php
                                        $drLikelihoodColor = $client->dr_likelihood === 'High' ? 'danger' : 
                                                           ($client->dr_likelihood === 'Medium' ? 'warning' : 'success');
                                    ?>
                                    <span class="badge bg-<?php echo e($drLikelihoodColor); ?>"><?php echo e($client->dr_likelihood); ?></span>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <?php if(isset($client->dr_risk_rating) && $client->dr_risk_rating): ?>
                                    <?php
                                        $drRatingColor = str_contains($client->dr_risk_rating, 'High') ? 'danger' : 
                                                       (str_contains($client->dr_risk_rating, 'Medium') ? 'warning' : 'success');
                                    ?>
                                    <span class="badge bg-<?php echo e($drRatingColor); ?>"><?php echo e($client->dr_risk_rating); ?></span>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="text-center">
                                <?php if(isset($client->total_points) && $client->total_points): ?>
                                    <?php
                                        $points = $client->total_points;
                                        $pointsClass = 'success'; // Green for 1-10
                                        if ($points >= 20) {
                                            $pointsClass = 'dark'; // Dark/Black for rejected (20+)
                                        } elseif ($points >= 17) {
                                            $pointsClass = 'danger'; // Red for high risk (17-19)
                                        } elseif ($points >= 11) {
                                            $pointsClass = 'warning'; // Orange for medium risk (11-16)
                                        }
                                    ?>
                                    <span class="badge bg-<?php echo e($pointsClass); ?>">
                                        <?php echo e($points); ?>

                                    </span>
                                <?php elseif($client->overall_risk_points): ?>
                                    <?php
                                        $points = $client->overall_risk_points;
                                        $pointsClass = 'success'; // Green for 1-10
                                        if ($points >= 20) {
                                            $pointsClass = 'dark'; // Dark/Black for rejected (20+)
                                        } elseif ($points >= 17) {
                            ...
                            <td class="text-center">
                                <?php if(isset($client->cra_overall_risk_rating) && $client->cra_overall_risk_rating): ?>
                                    <?php
                                    ...
                                    ?>
                                    <span class="badge bg-<?php echo e($overallRatingColor); ?>"><?php echo e($client->cra_overall_risk_rating); ?></span>
                                <?php elseif($client->overall_risk_rating): ?>
                                    <?php
                                    ...
                                    ?>
                                    <span class="badge bg-<?php echo e($overallRatingColor); ?>"><?php echo e($client->overall_risk_rating); ?></span>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <?php if(isset($client->comprehensive_acceptance) && $client->comprehensive_acceptance): ?>
                                    <?php
                                    ...
                                    ?>
                                    <span class="badge bg-<?php echo e($acceptanceColor); ?>"><?php echo e($client->comprehensive_acceptance); ?></span>
                                <?php elseif($client->client_acceptance): ?>
                                    <?php
                                        $acceptanceColor = $client->client_acceptance === 'Accept client' ? 'success' : 
                                                         ($client->client_acceptance === 'Reject client' ? 'danger' : 'warning');
                                    ?>
                                    <span class="badge bg-<?php echo e($acceptanceColor); ?>"><?php echo e($client->client_acceptance); ?></span>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <?php if(isset($client->comprehensive_monitoring) && $client->comprehensive_monitoring): ?>
                                    <span class="badge bg-info"><?php echo e($client->comprehensive_monitoring); ?></span>
                                <?php elseif($client->ongoing_monitoring): ?>
                                    <span class="badge bg-info"><?php echo e($client->ongoing_monitoring); ?></span>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <?php if($client->dcs_risk_appetite): ?>
                                    <span class="badge bg-secondary"><?php echo e($client->dcs_risk_appetite); ?></span>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <?php if($client->dcs_comments): ?>
                                    <small><?php echo e(Str::limit($client->dcs_comments, 25)); ?></small>
                                <?php else: ?>
                                    <span class="text-muted">N/A</span>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="text-center">
                                <div class="btn-group" role="group">
                                    <button type="button" class="btn btn-sm btn-outline-primary view-client-details" title="View Details" data-url="<?php echo e(route('clients.modal', $client)); ?>">
                                        <i class="fas fa-eye"></i>
                                    </button>
                                    <button class="btn btn-sm btn-outline-info" title="View Complete History" 
                                            onclick="viewClientHistory('<?php echo e($client->name); ?>', <?php echo e($client->id); ?>)">
                                        <i class="fas fa-history"></i>
                                    </button>
                                    <a href="<?php echo e(route('clients.edit', $client)); ?>" class="btn btn-sm btn-outline-warning" title="Edit" 
    ...
    <form id="bulkDeleteForm" method="POST" action="<?php echo e(route('clients.bulk-delete')); ?>" style="display: none;">
        <?php echo csrf_field(); ?>
        <?php echo method_field('DELETE'); ?>
        <input type="hidden" name="client_ids" id="bulkDeleteIds">
    </form>
    
    <form id="bulkExportForm" method="POST" action="<?php echo e(route('clients.bulk-export')); ?>" style="display: none;">
        <?php echo csrf_field(); ?>
...
function applyFilters() {
    ...
    tableRows.forEach(row => {
        ...
        const clientRiskCategory = row.querySelector('td:nth-child(6) .badge')?.textContent || 'N/A'; // CR Risk ID column
        const clientStatus = row.querySelector('td:nth-child(5) .badge')?.textContent || 'N/A'; // Client Screening Result column
        const clientRiskLevel = row.querySelector('td:nth-child(24) .badge')?.textContent || 'N/A'; // Overall Risk Rating column (corrected)
        
        let show = true;
        
        // Search filter - search across multiple fields
        if (searchTerm) {
            const crRiskId = row.querySelector('td:nth-child(6) .badge')?.textContent.toLowerCase() || '';
            const srRiskId = row.querySelector('td:nth-child(10) .badge')?.textContent.toLowerCase() || '';
            const prRiskId = row.querySelector('td:nth-child(14) .badge')?.textContent.toLowerCase() || '';
            const drRiskId = row.querySelector('td:nth-child(18) .badge')?.textContent.toLowerCase() || '';
        ...
        // Risk Level filter - trim whitespace and compare
        if (riskLevel && clientRiskLevel.trim() !== riskLevel) {
            show = false;
        }
...
function displayClientHistory(data, clientName) {
    ...
    if (data.assessments && data.assessments.length > 0) {
        ...
        html += '<tr>';
        html += '<th>Date</th>';
        html += '<th>Overall Points</th>';
        html += '<th>Overall Rating</th>';
        html += '<th>CR Risk</th>';
        html += '<th>SR Risk</th>';
        html += '<th>PR Risk</th>';
        html += '<th>DR Risk</th>';
        ...
        data.assessments.forEach((assessment, index) => {
            ...
            // Function to get color based on risk points
            const getPointsColor = (points) => {
                const p = parseInt(points) || 0;
                if (p >= 20) return 'dark';     // Dark/Black for rejected (20+)
                if (p >= 17) return 'danger';   // Red for high risk (17-19)
                if (p >= 11) return 'warning';  // Orange for medium risk (11-16)
                return 'success';               // Green for low risk (1-10)
            };
            
            // Function to display risk detail
            const displayRisk = (riskId, riskName, riskRating, points) => {
                if (!riskId) return '<small class="text-muted">N/A</small>';
                const ratingClass = getRiskRatingColor(riskRating);
                return `
                    <div>
                        <span class="badge bg-primary">${riskId}</span><br>
                        <small>${riskName || 'N/A'}</small><br>
                        <span class="badge bg-${ratingClass}">${riskRating || 'N/A'}</span>
                        <small>(${points || 0} pts)</small>
                    </div>
                `;
            };
            
            const pointsColor = getPointsColor(assessment.overall_risk_points);
            
            html += `
                <tr class="${isLatest ? 'table-success' : ''}">
                    <td style="min-width: 100px;">
                        <strong>${date}</strong>
                        ${isLatest ? '<br><span class="badge bg-success"><i class="fas fa-star"></i> Current</span>' : ''}
                    </td>
                    <td><span class="badge bg-${pointsColor}"><strong>${assessment.overall_risk_points || 0}</strong></span></td>
                    <td><span class="badge bg-${riskColor}">${assessment.overall_risk_rating || 'N/A'}</span></td>
                    <td>${displayRisk(assessment.cr_risk_id, assessment.cr_risk_name, assessment.cr_risk_rating, assessment.cr_points)}</td>
                    <td>${displayRisk(assessment.sr_risk_id, assessment.sr_risk_name, assessment.sr_risk_rating, assessment.sr_points)}</td>
                    <td>${displayRisk(assessment.pr_risk_id, assessment.pr_risk_name, assessment.pr_risk_rating, assessment.pr_points)}</td>
                    <td>${displayRisk(assessment.dr_risk_id, assessment.dr_risk_name, assessment.dr_risk_rating, assessment.dr_points)}</td>
                    <td><small>${assessment.client_acceptance || 'N/A'}</small></td>
                    <td><small>${assessment.ongoing_monitoring || 'N/A'}</small></td>
                    <td><small>${assessment.approved_by_name || 'System'}</small></td>
                    <td>
                        <a href="/clients/${assessment.id}" class="btn btn-sm btn-outline-primary" target="_blank" title="View Full Details">
                            <i class="fas fa-eye"></i>
                        </a>
                    </td>
                </tr>
...
<?php echo $__env->make('layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\well-known\resources\views/clients/index.blade.php ENDPATH**/ ?>