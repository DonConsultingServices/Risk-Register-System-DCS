                        ...
                        <small class="text-muted"><?php echo e(Str::limit($client->pr_risk_name, 20)); ?></small>
                            ...
                            <td class="text-center">
                                <?php if(isset($client->total_points) && $client->total_points): ?>
                                    <span class="badge bg-<?php echo e($client->total_points >= 15 ? 'danger' : ($client->total_points >= 9 ? 'warning' : 'success')); ?>">
                                        <?php echo e($client->total_points); ?>

                                    </span>
                                <?php elseif($client->overall_risk_points): ?>
                                    <span class="badge bg-<?php echo e($client->overall_risk_points >= 15 ? 'danger' : ($client->overall_risk_points >= 9 ? 'warning' : 'success')); ?>">
                                        <?php echo e($client->overall_risk_points); ?>
...
<?php echo $__env->make('layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DCS-Best\resources\views/clients/index.blade.php ENDPATH**/ ?>