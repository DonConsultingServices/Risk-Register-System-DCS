<?php $__env->startSection('title', 'Client Risk Analysis'); ?>
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('clients.show', $client)); ?>"><?php echo e($client->name); ?></a></li>
                        <li class="breadcrumb-item active">Risk Analysis</li>
                    </ol>
                </div>
                <h4 class="page-title" style="color: #000000 !important;">Risk Analysis: <?php echo e($client->name); ?></h4>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h3 class="mt-3 mb-3"><?php echo e($client->total_risks); ?></h3>
                        </div>
                        <div class="avatar-sm">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h3 class="mt-3 mb-3 text-danger"><?php echo e($client->high_risks); ?></h3>
                        </div>
                        <div class="avatar-sm">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h3 class="mt-3 mb-3 text-warning"><?php echo e($client->open_risks); ?></h3>
                        </div>
                        <div class="avatar-sm">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h3 class="mt-3 mb-3 text-danger"><?php echo e($overdueRisks ?? 0); ?></h3>
                        </div>
                        <div class="avatar-sm">
                            <span class="avatar-title bg-soft-danger rounded">
                        ...
                        <div class="risk-matrix">
                            ...
                            <div class="matrix-row">
                                ...
                                <div class="matrix-cell risk-medium" data-risk="Medium Risk">
                                    <div class="risk-count"><?php echo e($matrixData['Very High']['Low'] ?? 0); ?></div>
                                </div>
                                <div class="matrix-cell risk-high" data-risk="High Risk">
                                    <div class="risk-count"><?php echo e($matrixData['Very High']['Medium'] ?? 0); ?></div>
                                </div>
                                <div class="matrix-cell risk-high" data-risk="High Risk">
                                    <div class="risk-count"><?php echo e($matrixData['Very High']['High'] ?? 0); ?></div>
                                </div>
                                <div class="matrix-cell risk-critical" data-risk="Critical Risk">
                                    <div class="risk-count"><?php echo e($matrixData['Very High']['Critical'] ?? 0); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="matrix-row">
                                ...
                                <div class="matrix-cell risk-low" data-risk="Low Risk">
                                    <div class="risk-count"><?php echo e($matrixData['High']['Low'] ?? 0); ?></div>
                                </div>
                                <div class="matrix-cell risk-medium" data-risk="Medium Risk">
                                    <div class="risk-count"><?php echo e($matrixData['High']['Medium'] ?? 0); ?></div>
                                </div>
                                <div class="matrix-cell risk-high" data-risk="High Risk">
                                    <div class="risk-count"><?php echo e($matrixData['High']['High'] ?? 0); ?></div>
                                </div>
                                <div class="matrix-cell risk-high" data-risk="High Risk">
                                    <div class="risk-count"><?php echo e($matrixData['High']['Critical'] ?? 0); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="matrix-row">
                                ...
                                <div class="matrix-cell risk-low" data-risk="Low Risk">
                                    <div class="risk-count"><?php echo e($matrixData['Medium']['Low'] ?? 0); ?></div>
                                </div>
                                <div class="matrix-cell risk-low" data-risk="Low Risk">
                                    <div class="risk-count"><?php echo e($matrixData['Medium']['Medium'] ?? 0); ?></div>
                                </div>
                                <div class="matrix-cell risk-medium" data-risk="Medium Risk">
                                    <div class="risk-count"><?php echo e($matrixData['Medium']['High'] ?? 0); ?></div>
                                </div>
                                <div class="matrix-cell risk-high" data-risk="High Risk">
                                    <div class="risk-count"><?php echo e($matrixData['Medium']['Critical'] ?? 0); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="matrix-row">
                                ...
                                <div class="matrix-cell risk-low" data-risk="Low Risk">
                                    <div class="risk-count"><?php echo e($matrixData['Low']['Low'] ?? 0); ?></div>
                                </div>
                                <div class="matrix-cell risk-low" data-risk="Low Risk">
                                    <div class="risk-count"><?php echo e($matrixData['Low']['Medium'] ?? 0); ?></div>
                                </div>
                                <div class="matrix-cell risk-low" data-risk="Low Risk">
                                    <div class="risk-count"><?php echo e($matrixData['Low']['High'] ?? 0); ?></div>
                                </div>
                                <div class="matrix-cell risk-medium" data-risk="Medium Risk">
                                    <div class="risk-count"><?php echo e($matrixData['Low']['Critical'] ?? 0); ?></div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('risks.create', ['client_id' => $client->id])); ?>" class="btn btn-primary">
                    ...
                    <?php if($client->risks->count() > 0): ?>
                        <div class="table-responsive">
                            <table class="table table-centered table-hover mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $client->risks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $risk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <div class="risk-id-container" 
                                                 data-risk-id="<?php echo e($risk->risk_id ?? $risk->id); ?>"
                                                 data-risk-title="<?php echo e($risk->title); ?>"
                                                 data-risk-description="<?php echo e($risk->description); ?>"
                                                 data-risk-category="<?php echo e($risk->category ? $risk->category->name : 'No category'); ?>"
                                                 data-risk-level="<?php echo e($risk->risk_level); ?>"
                                                 data-risk-status="<?php echo e($risk->status); ?>"
                                                 data-risk-impact="<?php echo e($risk->impact); ?>"
                                                 data-risk-likelihood="<?php echo e($risk->likelihood); ?>"
                                                 data-risk-owner="<?php echo e($risk->owner); ?>"
                                                 data-risk-created="<?php echo e($risk->created_at->format('M d, Y')); ?>"
                                                 data-risk-due="<?php echo e($risk->due_date ? $risk->due_date->format('M d, Y') : 'No due date'); ?>">
                                                <span class="risk-id-badge"><?php echo e($risk->risk_id ?? 'R-' . str_pad($risk->id, 4, '0', STR_PAD_LEFT)); ?></span>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="risk-description-container" 
                                                 ...
                                                 data-risk-created="<?php echo e($risk->created_at->format('M d, Y')); ?>"
                                                 data-risk-due="<?php echo e($risk->due_date ? $risk->due_date->format('M d, Y') : 'No due date'); ?>">
                                                <h6 class="mb-0 risk-title-hover"><?php echo e($risk->title); ?></h6>
                                                <small class="text-muted risk-description-hover"><?php echo e(Str::limit($risk->description, 50)); ?></small>
                                            </div>
                                        </td>
                                        <td>
                                            <?php if($risk->category): ?>
                                                <span class="badge" style="background-color: <?php echo e($risk->category->color); ?>; color: white;">
                                                    <?php echo e($risk->category->name); ?>
                                        ...
                                        <td>
                                            <?php if($risk->assignedUser): ?>
                                                <?php echo e($risk->assignedUser->name); ?>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <a href="<?php echo e(route('risks.show', $risk)); ?>" class="btn btn-outline-primary">
                                                    <i class="mdi mdi-eye"></i>
                                                </a>
                                                <a href="<?php echo e(route('risks.edit', $risk)); ?>" class="btn btn-outline-secondary" 
...
<link rel="stylesheet" href="<?php echo e(asset('css/matrix.css')); ?>">
<style>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(levelCtx, {
        ...
        data: {
            ...
            datasets: [{
                data: [<?php echo e($client->low_risks); ?>, <?php echo e($client->medium_risks); ?>, <?php echo e($client->high_risks); ?>, <?php echo e($criticalRisks ?? 0); ?>],
    ...
    new Chart(statusCtx, {
        ...
        data: {
            ...
            datasets: [{
                data: [<?php echo e($openRisks ?? 0); ?>, <?php echo e($inProgressRisks ?? 0); ?>, <?php echo e($closedRisks ?? 0); ?>, <?php echo e($onHoldRisks ?? 0); ?>],
...
<?php echo $__env->make('layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\well-known\resources\views/clients/risk-analysis.blade.php ENDPATH**/ ?>