...
<?php $__env->startSection('title', 'Risk Approvals'); ?>
...
<div class="container-fluid">
    ...
    <div class="stats-grid">
        <a href="<?php echo e(route('risks.approval.index', ['status' => 'pending'])); ?>" 
           class="stat-card pending <?php echo e($status === 'pending' ? 'active' : ''); ?>">
            <div class="stat-number text-warning"><?php echo e($stats->pending); ?></div>
            <div class="stat-label">Pending Approval</div>
        </a>
        <a href="<?php echo e(route('risks.approval.index', ['status' => 'approved'])); ?>" 
           class="stat-card approved <?php echo e($status === 'approved' ? 'active' : ''); ?>">
            <div class="stat-number text-success"><?php echo e($stats->approved); ?></div>
            <div class="stat-label">Approved</div>
        </a>
        <a href="<?php echo e(route('risks.approval.index', ['status' => 'rejected'])); ?>" 
           class="stat-card rejected <?php echo e($status === 'rejected' ? 'active' : ''); ?>">
            <div class="stat-number text-danger"><?php echo e($stats->rejected); ?></div>
    ...
    <div class="risks-table-card">
        <div class="card-header">
            <h5>
                <i class="fas fa-<?php echo e($status === 'pending' ? 'clock' : ($status === 'approved' ? 'check-circle' : 'times-circle')); ?> me-2"></i>
                <?php echo e(ucfirst($status)); ?> Risk Approvals
            </h5>
        </div>
        <div class="card-body p-0">
            <?php if($risks->count() > 0): ?>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <?php if($status === 'pending'): ?>
                                <td>
                                    <input type="checkbox" class="form-check-input risk-checkbox" value="<?php echo e($risk->id); ?>">
                                </td>
                                <?php endif; ?>
                                <td>
                                ...
                                <td>
                                    <div class="risk-title"><?php echo e($risk->title); ?></div>
                                    <div class="risk-description"><?php echo e(Str::limit($risk->description, 60)); ?></div>
                                </td>
                                <td>
                                    <?php if($risk->client): ?>
                                ...
                                <td>
                                    <?php if($risk->creator): ?>
                                        <span class="fw-medium"><?php echo e($risk->creator->name); ?></span>
                                        <br><small class="text-muted"><?php echo e($risk->creator->role_display_name); ?></small>
                                    <?php else: ?>
                                ...
                                <td>
                                    ...
                                    <br><small class="text-muted"><?php echo e($risk->created_at->diffForHumans()); ?></small>
                                </td>
                                <td>
                                    <div class="action-buttons">
                                        <a href="<?php echo e(route('risks.approval.show', $risk)); ?>" class="btn btn-sm btn-outline-primary" title="View Details">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <?php if($status === 'pending'): ?>
                                        <button class="btn btn-sm btn-success" onclick="approveRisk(<?php echo e($risk->id); ?>)" title="Approve">
                                            <i class="fas fa-check"></i>
                                        </button>
                                        <button class="btn btn-sm btn-danger" onclick="rejectRisk(<?php echo e($risk->id); ?>)" title="Reject">
            ...
            <?php else: ?>
                <div class="empty-state">
                    <i class="fas fa-<?php echo e($status === 'pending' ? 'clock' : ($status === 'approved' ? 'check-circle' : 'times-circle')); ?>"></i>
                    <h5>No <?php echo e(ucfirst($status)); ?> Risks</h5>
                    <p>
                        <?php if($status === 'pending'): ?>
...
<?php echo $__env->make('layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DCS-Best\resources\views/risks/approval/index.blade.php ENDPATH**/ ?>