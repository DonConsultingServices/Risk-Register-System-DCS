<?php $__env->startSection('title', 'Risk Register - Client Acceptance & Retention Risk Register'); ?>
<?php $__env->startSection('page-title', 'Risk Register'); ?>
...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="header-actions">
                <a href="<?php echo e(route('risks.create')); ?>" class="btn-new-risk">
    ...
    <div class="feature-cards">
        <div class="feature-card">
            ...
            <a href="<?php echo e(route('risks.create')); ?>" class="feature-btn">
                <i class="fas fa-plus"></i>
        ...
        <div class="feature-card">
            ...
            <a href="<?php echo e(route('clients.index')); ?>" class="feature-btn">
        ...
        <div class="feature-card">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" class="feature-btn">
                    ...
                    <div class="row text-center">
                        <div class="col-md-4 col-6 mb-3">
                            <div class="border rounded p-3">
                                <h3 class="text-primary mb-1"><?php echo e($totalRisks); ?></h3>
                                <p class="text-muted mb-0">Total Risks</p>
                            </div>
                        </div>
                        <div class="col-md-4 col-6 mb-3">
                            <div class="border rounded p-3">
                                <h3 class="text-warning mb-1"><?php echo e($openRisks); ?></h3>
                                <p class="text-muted mb-0">Open Risks</p>
                            </div>
                        </div>
                        <div class="col-md-4 col-6 mb-3">
                            <div class="border rounded p-3">
                                <h3 class="text-danger mb-1"><?php echo e($highRisks); ?></h3>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('risks.create')); ?>" class="btn btn-sm btn-primary">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <strong><?php echo e($risk->title); ?></strong>
                                        <?php if($risk->description): ?>
                                            <br><small class="text-muted"><?php echo e(Str::limit($risk->description, 50)); ?></small>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <?php if($risk->client): ?>
                                        ...
                                        <?php elseif($risk->client_name): ?>
                                            <span class="text-primary"><?php echo e($risk->client_name); ?></span>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <?php if($risk->category): ?>
                                            <span class="badge bg-info"><?php echo e($risk->category->name); ?></span>
                                        <?php elseif($risk->risk_category): ?>
                                            <span class="badge bg-info"><?php echo e($risk->risk_category); ?></span>
                                        <?php else: ?>
                                            <span class="text-muted">-</span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <span class="badge bg-<?php echo e($risk->risk_rating == 'High' ? 'danger' : ($risk->risk_rating == 'Medium' ? 'warning' : 'success')); ?>">
                                            <?php echo e($risk->risk_rating); ?>

                                        </span>
                                    </td>
                                    <td>
                                        <span class="badge bg-<?php echo e($risk->status == 'Open' ? 'primary' : ($risk->status == 'Closed' ? 'success' : 'secondary')); ?>">
                                            <?php echo e($risk->status); ?>

                                        </span>
                                    </td>
                                    <td>
                                        <small class="text-muted"><?php echo e($risk->created_at->format('M d, Y')); ?></small>
                                    </td>
                                </tr>
    ...
    <div class="info-section">
        ...
        <p class="mt-3 mb-0">
            ...
            <a href="<?php echo e(route('clients.index')); ?>" class="text-decoration-none fw-bold">Client Management</a> 
...
<?php echo $__env->make('layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\well-known\resources\views/risks/index.blade.php ENDPATH**/ ?>