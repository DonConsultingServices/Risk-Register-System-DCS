    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('risks.store')); ?>" method="POST" id="riskForm" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="date" class="form-control" name="assessment_date" id="assessment_date" 
                                           min="<?php echo e(date('Y-m-d')); ?>" max="<?php echo e(date('Y-m-d')); ?>" required>
                                        ...
                                        <tr class="risk-row">
                                            ...
                                            <td class="risk-selection-cell">
                                                <select name="sr_selection" id="sr_selection" class="form-select risk-select" required>
                                                    ...
                                                    <?php $__currentLoopData = $riskCategories->where('risk_category', 'SR'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $risk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($risk->risk_id); ?>" 
                                                            data-name="<?php echo e($risk->risk_name); ?>"
                                                            data-detail="<?php echo e($risk->risk_detail); ?>"
                                                            data-category="<?php echo e($risk->risk_category); ?>"
                                                            data-impact="<?php echo e($risk->impact); ?>"
                                                            data-likelihood="<?php echo e($risk->likelihood); ?>"
                                                            data-rating="<?php echo e($risk->risk_rating); ?>"
                                                            data-mitigation="<?php echo e($risk->mitigation_strategies); ?>"
                                                            data-owner="<?php echo e($risk->owner); ?>"
                                                            data-status="<?php echo e($risk->status); ?>">
                                                        <?php echo e($risk->risk_id); ?> - <?php echo e($risk->risk_name); ?>
                                        ...
                                        <tr class="risk-row">
                                            ...
                                            <td class="risk-selection-cell">
                                                <select name="cr_selection" id="cr_selection" class="form-select risk-select" required>
                                                    ...
                                                    <?php $__currentLoopData = $riskCategories->where('risk_category', 'CR'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $risk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($risk->risk_id); ?>" 
                                                            data-name="<?php echo e($risk->risk_name); ?>"
                                                            data-detail="<?php echo e($risk->risk_detail); ?>"
                                                            data-category="<?php echo e($risk->risk_category); ?>"
                                        ...
                                        <tr class="risk-row">
                                            ...
                                            <td class="risk-selection-cell">
                                                <select name="pr_selection" id="pr_selection" class="form-select risk-select" required>
                                                    ...
                                                    <?php $__currentLoopData = $riskCategories->where('risk_category', 'PR'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $risk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($risk->risk_id); ?>" 
                                                            data-name="<?php echo e($risk->risk_name); ?>"
                                                            data-detail="<?php echo e($risk->risk_detail); ?>"
                                                            data-category="<?php echo e($risk->risk_category); ?>"
                                        ...
                                        <tr class="risk-row">
                                            ...
                                            <td class="risk-selection-cell">
                                                <select name="dr_selection" id="dr_selection" class="form-select risk-select" required>
                                                    ...
                                                    <?php $__currentLoopData = $riskCategories->where('risk_category', 'DR'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $risk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($risk->risk_id); ?>" 
                                                            data-name="<?php echo e($risk->risk_name); ?>"
                                                            data-detail="<?php echo e($risk->risk_detail); ?>"
                                                            data-category="<?php echo e($risk->risk_category); ?>"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="d-flex flex-column gap-3">
                                        ...
                                        <a href="<?php echo e(route('risks.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\well-known\resources\views/risks/create.blade.php ENDPATH**/ ?>