    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title" style="color: #000000 !important;">Risk Categories</h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="alert alert-info border-0 shadow-sm">
                <div class="d-flex align-items-start">
                    <i class="fas fa-info-circle fa-2x me-3 mt-1" style="color: #00072D;"></i>
                    <div>
                        <h5 class="alert-heading mb-2"><strong>How to Use Risk Categories</strong></h5>
                        <p class="mb-2"><strong>Risk Categories</strong> are used to organize and classify different types of risks in your system. Here's what you can do:</p>
                        
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <h6 class="text-primary mb-2"><i class="fas fa-plus-circle me-2"></i>To Add a New Risk Assessment:</h6>
                                <ol class="mb-3" style="font-size: 0.95rem;">
                                    <li>Click the <span class="badge bg-success">Add New Risk</span> button above</li>
                                    <li>Fill in client information</li>
                                    <li>Select risks from categories (SR, CR, PR, DR)</li>
                                    <li>Submit to create client assessment</li>
                                </ol>
                                
                                <h6 class="text-primary mb-2"><i class="fas fa-folder-plus me-2"></i>To Create a New Category:</h6>
                                <ol class="mb-3" style="font-size: 0.95rem;">
                                    <li>Click the <span class="badge bg-primary">Add Category</span> button above</li>
                                    <li>Enter category name, description, and color</li>
                                    <li>Save to add to the system</li>
                                </ol>
                            </div>
                            
                            <div class="col-md-6">
                                <h6 class="text-primary mb-2"><i class="fas fa-edit me-2"></i>To Edit a Category:</h6>
                                <ol class="mb-3" style="font-size: 0.95rem;">
                                    <li>Find the category in the table below</li>
                                    <li>Click the <span class="badge bg-warning text-dark"><i class="fas fa-edit"></i></span> (Edit) icon in the Actions column</li>
                                    <li>Update the information and save</li>
                                </ol>
                                
                                <h6 class="text-primary mb-2"><i class="fas fa-tasks me-2"></i>Bulk Actions:</h6>
                                <ol class="mb-0" style="font-size: 0.95rem;">
                                    <li>Check the boxes next to categories you want to manage</li>
                                    <li>Select an action from the "Bulk Actions" dropdown</li>
                                    <li>Click "Apply" to execute the action</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="alert alert-warning mt-3 mb-0">
                            ...
                            <strong>Note:</strong> The main risk categories (CR, SR, PR, DR) are managed through the <a href="<?php echo e(route('risks.create')); ?>" class="alert-link"><strong>Risk Register</strong></a>. This page shows additional custom risk categories for extended classification.
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\well-known\resources\views/risk-categories/index.blade.php ENDPATH**/ ?>