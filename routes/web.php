...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:admin,manager'])->group(function () {
        ...
        Route::post('/system/backup/database', [RiskController::class, 'backupDatabase'])->name('system.backup.database');
        Route::post('/system/backup/full', [RiskController::class, 'backupFull'])->name('system.backup.full');
    });
